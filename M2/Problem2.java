...
public class Problem2 {
    ...
    static void getTotal(double[] arr){
        ...
        //used help for learning string formatting from the website https://www.javatpoint.com/java-string-format
        String twoSpaces = String.format("%.2f",total);
        totalOutput = twoSpaces;
